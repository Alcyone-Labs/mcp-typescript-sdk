...
const BaseNotificationParamsSchema = zod_1.z.looseObject({
    /**
     * See [MCP specification](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/47339c03c143bb4ec01a26e721a1b8fe66634ebe/docs/specification/draft/basic/index.mdx#general-fields)
     * for notes on _meta usage.
     */
    _meta: zod_1.z.optional(zod_1.z.looseObject({})),
});
exports.NotificationSchema = zod_1.z.object({
    method: zod_1.z.string(),
    params: zod_1.z.optional(BaseNotificationParamsSchema),
});
exports.ResultSchema = zod_1.z.looseObject({
    /**
     * See [MCP specification](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/47339c03c143bb4ec01a26e721a1b8fe66634ebe/docs/specification/draft/basic/index.mdx#general-fields)
     * for notes on _meta usage.
     */
...
exports.JSONRPCRequestSchema = zod_1.z
    ...
    .extend(exports.RequestSchema.shape);
const isJSONRPCRequest = (value) => {
    const result = exports.JSONRPCRequestSchema.safeParse(value);
...
exports.JSONRPCNotificationSchema = zod_1.z
    ...
    .extend(exports.NotificationSchema.shape);
const isJSONRPCNotification = (value) => {
    const result = exports.JSONRPCNotificationSchema.safeParse(value);
    return result.success;
};
 ...
 */
exports.JSONRPCResponseSchema = zod_1.z.strictObject({
    jsonrpc: zod_1.z.literal(exports.JSONRPC_VERSION),
    id: exports.RequestIdSchema,
    result: exports.ResultSchema,
});
const isJSONRPCResponse = (value) => {
    const result = exports.JSONRPCResponseSchema.safeParse(value);
    return result.success;
};
 ...
 */
exports.JSONRPCErrorSchema = zod_1.z.strictObject({
    jsonrpc: zod_1.z.literal(exports.JSONRPC_VERSION),
    id: exports.RequestIdSchema,
...
const isJSONRPCError = (value) => {
    const result = exports.JSONRPCErrorSchema.safeParse(value);
    return result.success;
};
 ...
 */
exports.EmptyResultSchema = zod_1.z.strictObject({}).extend(exports.ResultSchema.shape);
/* Cancellation */
/**
 ...
 */
const BaseMetadataSchema = zod_1.z.looseObject({
 ...
 */
exports.ImplementationSchema = BaseMetadataSchema.extend({
...
const isInitializeRequest = (value) => {
    const result = exports.InitializeRequestSchema.safeParse(value);
    return result.success;
};
...
const isInitializedNotification = (value) => {
    const result = exports.InitializedNotificationSchema.safeParse(value);
    return result.success;
};
 ...
 */
exports.ResourceContentsSchema = zod_1.z.looseObject({
    /**
 ...
 */
exports.ResourceSchema = BaseMetadataSchema.extend({
    /**
     * The URI of this resource.
     */
    uri: zod_1.z.string(),
 ...
 */
exports.ResourceTemplateSchema = BaseMetadataSchema.extend({
    /**
 ...
 */
exports.PromptArgumentSchema = zod_1.z.looseObject({
    /**
 ...
 */
exports.PromptSchema = BaseMetadataSchema.extend({
    /**
 ...
 */
exports.TextContentSchema = zod_1.z.looseObject({
 ...
 */
exports.ImageContentSchema = zod_1.z.looseObject({
 ...
 */
exports.AudioContentSchema = zod_1.z.looseObject({
 ...
 */
exports.EmbeddedResourceSchema = zod_1.z.looseObject({
 ...
 */
exports.PromptMessageSchema = zod_1.z.looseObject({
 ...
 */
exports.ToolSchema = BaseMetadataSchema.extend({
    /**
    ...
    inputSchema: zod_1.z.object({
        ...
        properties: zod_1.z.optional(zod_1.z.looseObject({})),
     ...
     */
    outputSchema: zod_1.z.optional(zod_1.z.looseObject({
        type: zod_1.z.literal("object"),
        properties: zod_1.z.optional(zod_1.z.looseObject({})),
        required: zod_1.z.optional(zod_1.z.array(zod_1.z.string())),
    })),
...
exports.CallToolResultSchema = exports.ResultSchema.extend({
     ...
     */
    structuredContent: zod_1.z.looseObject({}).optional(),
    /**
 ...
 */
exports.ModelHintSchema = zod_1.z.looseObject({
    /**
 ...
 */
exports.ModelPreferencesSchema = zod_1.z.looseObject({
    /**
 ...
 */
exports.SamplingMessageSchema = zod_1.z.looseObject({
    role: zod_1.z.enum(["user", "assistant"]),
...
exports.CreateMessageRequestSchema = exports.RequestSchema.extend({
    ...
    params: BaseRequestParamsSchema.extend({
         ...
         */
        metadata: zod_1.z.optional(zod_1.z.looseObject({})),
        /**
 ...
 */
exports.BooleanSchemaSchema = zod_1.z.looseObject({
...
exports.ElicitRequestSchema = exports.RequestSchema.extend({
    ...
    params: BaseRequestParamsSchema.extend({
         ...
         */
        requestedSchema: zod_1.z.looseObject({
            type: zod_1.z.literal("object"),
 ...
 */
exports.ListRootsRequestSchema = exports.PaginatedRequestSchema.extend({
