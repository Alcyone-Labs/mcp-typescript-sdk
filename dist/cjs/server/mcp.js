            ...
            tools: Object.entries(this._registeredTools)
                ...
                const toolDefinition = {
                    ...
                    inputSchema: tool.inputSchema
                        ? zod_1.z.toJSONSchema(tool.inputSchema)
                        : EMPTY_OBJECT_JSON_SCHEMA,
                    annotations: tool.annotations,
                };
                if (tool.outputSchema) {
                    toolDefinition.outputSchema = zod_1.z.toJSONSchema(tool.outputSchema);
                }
        ...
        const registeredTool = {
            ...
            inputSchema: inputSchema === undefined
                ...
                : isZodTypeLike(inputSchema)
                    ? inputSchema
                    : zod_1.z.object(inputSchema),
            outputSchema: outputSchema === undefined
                ? undefined
                : isZodTypeLike(outputSchema)
                    ? outputSchema
                    : zod_1.z.object(outputSchema),
            annotations,
            callback,
            enabled: true,
...
function createCompletionResult(suggestions) {
    const filteredSuggestions = suggestions.filter((s) => s !== undefined);
    return {
        completion: {
